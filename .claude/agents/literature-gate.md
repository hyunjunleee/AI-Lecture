...
```json
{"stall_id":"LIT-NN-RR-001","loc":"theory.md Claim S1-C1","canonical_key":{"section":"Claim S1-C1","problem_type":"overclaim","target":"S1-C1","repair_channel":"theory-curator"},"source_id":"S1","claim_id":"S1-C1","why":"...","fix":"...","repair_channel":"theory-curator","research_question":null,"minimum_acceptance":null}
```
