...
- 비자명한 계산·긴 전개에서 극한/적분/급수/미분 교환 등의 근거가 *본문에* 제시됐는가(DCT/MCT/Fubini, 가측성, 적분가능성). **'computebox' 박스나 "대상/연산/목적/적법성" 키워드 나열의 부재는 stall이 아니다** — 근거가 산문으로 제시되면 충분하다. *근거 자체의 부재*가 stall이다.
- 수렴 양상 a.s./P/분포/Lp 구분, 밀도 사용 시 지배측도·절대연속성 확인.
